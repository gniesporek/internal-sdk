...
bool HooksManager::Setup()
{
    ...
    CreateHook("OnClientOutput", "engine2.dll", "48 89 5C 24 ? 55 56 57 41 56 41 57 48 83 EC ? 48 8D 05", false, &OnClientOutput::oOnClientOutput, OnClientOutput::hkOnClientOutput);
